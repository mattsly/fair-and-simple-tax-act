...
I have spent twenty years building software. Along the way, I've seen the tax code from many different angles: as a salaried employee, a startup employee with stock options, a big tech employee paid in RSUs, a founder with an exit, and an angel investor. And as both a software professional and a concerned citizen, I believe the American tax code (and capital gains taxation in particular) is the most consequential piece of technical debt in the United States.
...
**The estate tax.** If death is a realization event and all gains are taxed on the decedent's final return, the estate tax (which is woefully ineffective) becomes redundant and replaced with something that actually collects. (See *The Estate Tax Question* below.)
