...
Tax filing becomes simple, automated, and largely hands‑off. Everyone still files a tax return, but for most Americans it is pre‑filled automatically. You log in, review the information, make changes if needed, and confirm — no complex forms, schedules, or professional preparation required.

The Fair & Simple Tax Act replaces a black box with a system people can see, understand, and debate.
...
### **If Additional Revenue Is Needed: Menu of Options**

Should Congress determine additional revenue is necessary, the simplified tax base makes implementation straightforward:

| Option | Annual Revenue | Implementation Notes |
| :---- | :---- | :---- |
| **Carbon Tax** (\$50/ton) | \+\$100-150B | Environmental benefits, border-adjustable |
| **Financial Transaction Tax** (0.1%) | \+\$50-100B | Targets high-frequency trading, Wall Street pays |
| **Value-Added Tax** (10%) | \+\$800B-1T | OECD standard; requires rebate for regressivity |
| **Higher ESNC** (8% → 9%) | \+\$130B | Employer-side, invisible to workers |
| **Corporate Rate** (25% → 28%) | \+\$60B | Still below pre-TCJA 35% rate |
| **Estate Exemption** (\$5M → \$3M) | \+\$20-30B | Affects \~50K estates vs. \~30K |

Export to Sheets

**Note:** These options are NOT included in the base bill. They represent a menu for future Congresses if structural deficits persist. The Fair & Simple Tax Act creates the foundation; future legislators can build on it.

---

### **Revenue Model Summary**

| Period | Status | Confidence |
| :---- | :---- | :---- |
| **Years 1-20** | Revenue-neutral (Trust Fund \+ Growth) | High |
| **Years 20+** | Sustainable (options available if needed) | Medium |
