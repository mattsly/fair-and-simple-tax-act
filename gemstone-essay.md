...
*A thought experiment about the tax code we'd design if we could start over*

Imagine the U.S. federal government has been funded, since 1776, by a magic gemstone.
...
## First Things First: Yes, Cut Spending

I know what some of you are thinking. "We don't need a revenue system. We need to burn it all down. The government is too big. Cut spending. DOGE the whole thing."

And honestly? The first order of business in the post-gemstone world is to reexamine what we're spending. Obviously. You audit every line item. You eliminate genuine waste. You ask hard questions about whether every program is earning its keep. I'm with you. No argument.

But here's the math problem. The federal government spends roughly [$6.75 trillion per year](https://www.cbo.gov/publication/60870). About $1.8 trillion of that is Social Security. Another $900 billion is Medicare. $850 billion is defense. $880 billion is net interest on existing debt (and growing). That's $4.4 trillion before you've funded a single road, school, or air traffic controller. Even if you eliminated *every other function of the federal government* (the FBI, the VA, the national parks, food safety, all of it) you'd still need $4.4 trillion from somewhere.
...
OK, we never actually had a magic gemstone. We have the U.S. tax code. And it is, to put it gently, not what anybody would design on purpose.

The statutory code itself is [2,652 pages](https://taxfoundation.org/blog/how-many-words-are-tax-code/). The regulations interpreting it are another 7,655,000 words. Add the case law and IRS guidance and we're north of 75,000 pages. Americans spend [7.1 billion hours per year](https://taxfoundation.org/data/all/federal/irs-compliance-complexity-tax-costs/) just complying with this system (that's 3.4 million full-time workers doing nothing but paperwork). The total compliance cost is [$536 billion annually](https://taxfoundation.org/data/all/federal/irs-compliance-complexity-tax-costs/), or 1.8% of GDP. Not building products. Not funding research. Not making anyone healthier. Just navigating the system.

Over [90% of taxpayers](https://www.ntu.org/foundation/detail/taxpayers-will-spend-71-billion-hours-464-billion-on-tax-compliance-in-2025) now hire professionals or use tax software to file. Donald Rumsfeld, a man who ran the Department of Defense, once [sent the IRS a letter](https://taxfoundation.org/blog/what-does-donald-rumsfeld-have-common-franklin-roosevelt/) saying he had "absolutely no idea" whether his returns were accurate.
...
## Yes, This is a Silly Exercise (But It's a Useful One)
...
Because the foundation of our country is shifting in two profound ways, and they're both coming fast.

First, the deficit. We already mentioned the [$1.7 trillion annual gap](https://www.cbo.gov/publication/60870), but the trajectory is what matters. The national debt has crossed $38 trillion. Interest payments alone are now $880 billion a year, larger than the defense budget, and growing. Ray Dalio has [warned](https://www.cnbc.com/2025/03/12/ray-dalio-warns-growing-us-debt-will-lead-to-shocking-developments.html) that the U.S. is in a "debt death spiral" where the government has to sell a quantity of debt that the world is increasingly unwilling to buy. He puts the odds of a financial "trauma" at over 50% if it isn't addressed. This isn't partisan. The CBO's own projections show deficits growing every year for the next decade under current law. We are not on a path. We are on a clock.
...
Or we could do what any good engineer does when the technical debt becomes unserviceable: refactor.

---

## What I'd Build (And What's Next)

I've spent the last few months researching, talking to people, and thinking hard about what a greenfield system should actually look like. It's guided by four design tenets that, not surprisingly, are the four principles above: radical simplicity, fiscal durability, fueling the climb, and rewarding innovation. It's radical, but also pragmatic. There are pieces the political right and left will each like (and not like). I've gotten promising early feedback from policy researchers and several politicians. I think it's pretty elegant, if I do say so myself.

The first component is the Lifetime Gains Framework: a single, unified treatment of all income — wages, capital gains, dividends, inheritance — that replaces the current patchwork with one system, two rates, and no loopholes worth hiring a lawyer for. I'll lay it out in my next post.

Behind it is a complete rethink of income taxes, payroll taxes, child benefits, and retirement savings, each designed to pass the gemstone test: *is this something you'd actually build from scratch?*

One more thing about the gemstone.

I started this essay with a fantasy about government revenue. A magic rock that just... handled it. And I said the gemstone combusted. Bummer. But if AI delivers anything close to what its proponents believe, we're heading toward an economy of radical abundance — where the question stops being "how do we split the cost?" and starts being "how do we distribute the surplus?" That world needs a tax system built from first principles. Built for clarity. Built to evolve.

A system of 75,000 pages can barely handle the economy we have now. It has no chance of adapting to the one that's coming.

The tax code is America's most expensive technical debt. Time to write some clean code.

Next up: the Lifetime Gains Framework. Stay tuned.

---

*Matt Sly is a software entrepreneur. Supporting analysis and detailed proposals are available at [mattsly.com](https://www.mattsly.com/fair-and-simple-tax-act). Revenue estimates and editorial assistance provided by Claude AI. All policy positions and framework design are the author's own.*
