...
This proposal is not affiliated with a political party, campaign, or institution. It is an attempt to apply systems thinking, real-world experience, and clear tradeoffs to a problem that sits at the intersection of economics, equity, and long-term national health.
...
The tax code should be broadly understood and almost entirely automated. Simplicity reduces compliance costs, economic deadweight loss, and evasion vectors. Simplicity also enables broader understanding of trade-offs and more meaningful public debate about national priorities.

**2. Fiscal Durability**
The reform must be meaningfully revenue-positive and resilient to political cycles. Reforms that are merely "revenue neutral" are no longer sufficient — any structural change to the tax code must contribute to restoring long-term budget sustainability. Revenue estimates must account for behavioral responses.

**3. Fuel the Climb**
Americans who are seeking to climb the economic ladder should be unambiguously better off under this framework than under current law. The system should reward work, saving, and wealth-building. It should not create structural advantages that entrench dynastic wealth at the expense of economic ascendancy.

**4. Reward Innovation**
Risk-taking and entrepreneurship have genuine social value. The framework must preserve strong incentives to start companies, build businesses, and allocate capital productively — particularly where risk is highest and social returns are greatest.
...
Because the lifetime gains system is universal and closes all deferral escape routes, an extraordinary amount of existing tax infrastructure becomes redundant. The framework doesn't just reform capital gains — it renders entire categories of tax law unnecessary.

**Three shadow tax codes eliminated:**

| Tax | Current Revenue | Why It's Now Redundant |
|---|---|---|
| Estate Tax | ~$20-25B/yr | Deemed realization at death collects multiples more — with no avoidance path. The estate tax's existence has historically justified stepped-up basis, which costs $75-100B/yr. Abolishing both and replacing with deemed realization is a massive net gain. ([See FAQ: Why abolish the estate tax?](#q-why-abolish-the-estate-tax-instead-of-fixing-it)) |
...
| Collectibles Rate (28%) | No principled basis for a separate asset-class rate. Everything flows through the same system. |
...
| QSBS Rollover (Section 1045) | Another deferral mechanism. Redundant when the exemption already protects early-stage gains. |
...
| Stepped-Up Basis | Eliminated. Death is a realization event; heirs receive a clean basis at date-of-death value. |
...
**The coalition math:** *"Under our proposal, a married couple can accumulate up to $20 million in tax-free or tax-advantaged wealth — $10 million in lifetime capital gains and $10 million across two Roth accounts."*
...
**Roth Reform:** [Roth account changes and the Thiel loophole](#q-how-do-roth-accounts-change-and-what-about-the-thiel-loophole)

**On the Framework Design:** [Why not income from dollar one?](#q-why-not-tax-capital-gains-as-ordinary-income-from-dollar-one) · [Why not higher rates?](#q-why-not-higher-rates) · [Inflation indexing complexity?](#q-what-about-inflation-indexing)
...
- The exemption is **per individual** and begins at enactment (only post-enactment gains count).
- Assets must be held **more than one year** to qualify for the exemption; short-term gains are taxed as ordinary income (same as current law).
- The exemption amount is **indexed to inflation** annually using CPI, with adjustments applied prospectively: increases add headroom for everyone; decreases apply only to gains realized after the change (no retroactive clawback).
...
**Why this design?** The "bunching" problem (that large gains are realized infrequently) has historically been one of strongest argument against taxing gains as income. With this design, it is addressed by the rate structure itself rather than by a separate averaging mechanism. A founder who sells a company after 25 years of hard work for $10M doesn't get hit with a sudden 37% rate; the sliding scale ensures the effective rate reflects their position in the phase-up range. This eliminates the need for holding-period averaging (see [Open Question #4](#4-is-holding-period-averaging-still-needed-under-a-sliding-scale)), which is a significant simplicity win — particularly for private businesses, real estate, and farms where computing averaged gains adds complexity.
...
**2. Gifts are realization events.** The donor pays tax at the time of transfer using their own lifetime counter. This neutralizes GRATs, dynasty trusts, and every other technique that relies on transferring appreciation without triggering tax. The recipient receives a clean basis at the gift-date value.
...
*([Technical spec §2, Rule 4](./technical_spec.md#rule-4-cpi-indexed-basis) has the precise gains/losses determination logic.)*
...
**CPI adjustment is fully symmetric:** it applies to both gains and losses. Because Rule 3's terminal realization events (death, gifts, borrowing) ensure that all deferred gains are eventually taxed, asymmetric rules to handicap tax-loss harvesting are unnecessary. The framework taxes only real economic gains and recognizes only real economic losses.

Implementation is straightforward: brokerages already track purchase dates and cost basis; the BLS publishes monthly CPI. The calculation is a lookup table multiplication that any brokerage system can automate. CPI-adjusted basis is used for all transactions. For assets acquired by gift or deemed realization at death, the basis date resets to the transfer date.
...
- **Inflation-adjusted.** Both gains and losses entering the counter are real values after CPI basis adjustment. See [CPI basis indexing FAQ](#q-how-does-cpi-basis-indexing-work) for details.
...
#### Q: Why abolish the estate tax instead of fixing it?

This is the core insight, drawn from Professor Ray Madoff's *The Second Estate* (2025): the estate tax functions as political cover. Its existence justifies excluding inheritances from income tax, while its hollowed-out structure — GRATs, dynasty trusts, valuation discounts, stepped-up basis — ensures the wealthy pay neither.
...
The lifetime gains framework resolves this by eliminating the structural conditions that made every one of these provisions necessary. When gains are tracked cumulatively, taxed as income above a generous exemption, and realized at death, gift, and borrowing — the rationale for parallel tax codes, narrow exclusions, and estate planning loopholes simply disappears.

Yes, a small number of families who were honestly paying the full estate tax without avoidance will pay slightly less. That is the explicit trade: a tax that theoretically collects 40% but actually collects 10% is replaced by a tax that reliably collects 34-37% with no escape. The government collects more in aggregate.

#### Q: Without an estate tax, do we enable perpetual dynastic fortunes?
...
1. **Realization at every generation.** New appreciation is taxed at ordinary income rates (up to 37%) at each death, gift, or borrowing event. A $500M fortune that grows to $900M over 25 years loses ~$148M to capital gains tax at the next generational transfer.
...
The combined effect: realization-at-death + ordinary income rates + dilution + inflation does substantial erosion work without a separate tax on the stock of wealth.
...
**Outcomes vary for reasons beyond effort.** Among equally talented, equally hardworking founders, the spread between a $5M exit and a $50M exit reflects market timing, competitive dynamics, network effects, and macroeconomic conditions as much as individual merit. Kauffman Foundation research consistently finds that serial founders are motivated primarily by autonomy, problem-solving, and the challenge itself — not by marginal differences in after-tax returns. The exemption rewards the skill and effort. The rate above it reflects that outsized outcomes involve significant variance not attributable to the founder's work alone.

**The VC portfolio argument:** VCs will argue that fund-level returns depend on outsized exits, and higher tax rates shrink those returns. True at the margin — but VC fund economics are driven by 2-3 home-run investments that return 10-50x. The tax differential between 23.8% and ~35% on a 30x return does not change the investment decision. A deal that returns $100M is still a great deal at a 35% rate. The threshold where taxation materially alters VC portfolio construction is well above the range where this framework operates.

#### Q: Won't eliminating 1031 exchanges crash the real estate market?
...
**The proposal makes four changes to Roth IRAs:**

1. **Remove income limits** for direct Roth contributions. This eliminates the backdoor Roth conversion (? does it though? why can't I also do a backdoor roth? don't we need to explicitly prevent those now?), the mega-backdoor Roth, and the conversion ladder — three layers of complexity that exist only because the current income phaseout ($161K single / $240K married) forces high earners into workarounds. Every American can contribute directly to a Roth, period.

2. **Raise the annual contribution cap** to $15,000 (indexed to inflation), up from $7K/$8K. This is generous for ordinary savers while keeping the cap meaningful.

3. **$5 million balance cap per person** across all Roth-type accounts (IRA + 401(k)). Once your combined Roth balance reaches $5M, no new contributions are accepted. Investment growth above $5M continues tax-free — the Roth promise is honored. The cap simply prevents further tax-advantaged inputs. This is consistent with the framework's realization-based philosophy: we don't tax unrealized gains anywhere else, and we don't start here.

4. **Existing mega-Roths grandfathered.** No forced distributions. No retroactive taxation. For accounts already above $5M (including cases like Thiel's), contributions are frozen immediately — no new money in. Growth continues tax-free. This honors the original contract: you paid tax on the way in, and the deal stands. But the door to building *new* mega-Roths is closed.

**Math check:** $15K/year for 40 years at 8% real returns ≈ $4.2M. It is nearly impossible to hit the $5M cap through normal contributions. The cap only catches the abuse case — undervalued asset stuffing and mega-backdoor conversions.

**At death:** Roth accounts pass tax-free to beneficiaries under the existing 10-year distribution rule. No change. This honors the original Roth promise — you paid tax on the way in; it's tax-free on the way out — while the $5M cap prevents abuse.

**Revenue impact:** Without growth taxation, the Roth reform generates revenue primarily through one channel: removing the income phaseout shifts high earners from Traditional IRA deductions to Roth contributions. About 15-20M tax filers currently earn $161K–$500K and can't do direct Roth. If even half shift $7K/year from Traditional to Roth, they stop taking the Traditional IRA deduction, generating roughly **$7-15B/year in accelerated revenue** in the first decade. This is a timing shift (revenue pulled forward from future Traditional IRA withdrawals), but it helps the 10-year budget window that matters for legislative scoring. The $5M contribution freeze prevents new mega-Roths from forming but does not generate direct revenue from existing accounts.

**There are no changes** to Traditional 401(k)s, Traditional IRAs, SEP IRAs, or SIMPLE IRAs. A broader retirement account simplification is deferred to a companion proposal.
...
Under this framework, gains above the $2.5M exemption *are* taxed as ordinary income. The question is: why even distinguish between capital gains and wages income? Why not combine all annual taxpaper income and use the same rate table? Five reasons:
...
2. **Inflation cushion.** CPI basis adjustment handles most inflation effects, but for assets held over very long periods (30+ years), small measurement errors compound. The exemption provides a generous buffer that ensures no one is taxed on phantom gains.

3. **Capital formation has genuine social value** that diminishes as wealth accumulates. The first dollar of gain to someone with no savings is often spent or invested in ways that expand productive capacity. The billionth dollar for a billionaire is most likely reinvested in wealth management. The exemption concentrates the tax-free benefit where the social return on capital is highest.

4. **Lock-in.** At income tax rates from dollar one, the incentive to never sell becomes overwhelming for small investors, reducing market liquidity and capital reallocation. The exemption eliminates lock-in for 99%+ of households.

5. **Political viability.** Full equalization from dollar one gets zero votes in the current Congress. The exemption is the coalition-builder — it's what makes estate tax repeal a trade rather than a giveaway.

(? can we also point out that basically no other countries do this and we'd really risk capital flight? )

#### Q: Why not higher rates?

The rates on gains above the exemption *are* the ordinary income rates. The top marginal rate is whatever the top income tax bracket is — currently 37%. This is a clean, defensible principle: investment income and wage income are taxed identically.

The question becomes: why not raise the top income tax rate? That's a legitimate debate, but it's a *separate* debate. This framework doesn't require any changes to income tax rates. If Congress later decides to add a 45% or 50% bracket for income above $5M, capital gains above the exemption would automatically be taxed at those rates too. The system is designed so that rate adjustments are a single lever — change the income tax table and everything adjusts.

For the revenue-focused: Zidar et al. (Princeton) find the revenue-maximizing capital gains rate under base-broadening is 40-47%, well above the current 37% top rate. There is headroom if needed. But leading with rate convergence at existing income tax rates is the strongest opening position — it neutralizes the "this is just a tax increase dressed up as reform" attack.

#### Q: What happens to qualified dividends?

Under current law, qualified dividends are taxed at the same preferential rates as long-term capital gains (0/15/20%). This alignment was deliberate — the 2003 JGTRRA equalized them to eliminate tax distortions on corporate payout decisions.

Under this framework, qualified dividends are treated identically to capital gains: they count against the lifetime exemption, and above the exemption they are taxed as ordinary income. This preserves the current alignment — dividends and gains are taxed the same — at the new, higher rates.
...
#### Q: What about inflation indexing? Does this add complexity?
...
#### Q: What happens with marriage and divorce?
...
**Custom allocation:** The 50/50 default can be overridden by prenuptial agreement or joint tax election. A couple where one spouse enters with significantly more exemption headroom can agree to allocate gains to the higher-counter spouse first, preserving the lower-counter spouse's remaining exemption. For 95%+ of couples, the default is fine and requires no planning.

**Why this design?** Individual counters eliminate "capital gains divorce planning" entirely. There is no advantage to timing a divorce around asset sales, no complexity in unwinding a shared pool, and no opportunity for marriage as an exemption-transfer vehicle. The counter belongs to the person, not the marriage.
...
#### Q: What about expatriation and capital flight?

Renouncing citizenship already triggers an exit tax under current law (IRC §877A, enacted 2008) — a mark-to-market deemed sale of all worldwide assets. This framework preserves and strengthens that mechanism: expatriation triggers deemed realization of all gains, with the lifetime exemption and sliding scale applied. Payment flexibility for illiquid assets. This is not a new realization event — it's an existing one that aligns naturally with the framework's three core triggers (death, gifts, borrowing).
...
The attack ad writes itself: *"They repealed the Medicare tax!"* The rebuttal: we didn't repeal it — we made it unnecessary by raising 5-8x more total revenue. Medicare's actual funding increases. A companion proposal on payroll tax reform will address the broader question of whether Medicare and Medicaid funding should be formally consolidated into general revenue.
...
- **Trust-held gains:** Taxed to the trust at the top income tax rate (37%) in the year realized. Trusts do not receive their own lifetime exemption.
- **Distributions to beneficiaries:** Taxed using the beneficiary's lifetime counter and income.
- **No allowance stacking:** Trusts cannot multiply the exemption across generations.
...
#### Q: Won't this force families to sell farms and businesses?
...
#### Q: How is this "radical simplicity" if you're adding lifetime tracking?
...
#### Q: Canada has a lifetime capital gains system that got more complex over time. What makes this different?
...
- **NIIT becoming redundant** lets Republicans claim they eliminated a piece of the Affordable Care Act.
...
#### Q: Who opposes this and why?

**More pushback from the right.** Five constituencies:

1. **Investment class ($10M+ in gains):** Loudest and most funded. Effective rate jumps from ~23.8% to 34-37%. But the exemption and three-tax repeal provide cover.
...
#### Q: Why not just impose a wealth tax?

Wealth taxes have failed in most countries that tried them. France, Sweden, Austria, and others repealed their wealth taxes after discovering:
...
- **Constitutional risk:** A federal wealth tax faces serious Article I challenges; deemed realization at death is low risk post-*Moore v. United States*.

This framework achieves the same progressivity through realization events (sales, death, gifts, borrowing), which are easier to value (transaction prices, not annual appraisals), harder to evade (documented transactions with third-party reporting), and more enforceable (uses existing IRS infrastructure). By expanding realization events and taxing gains as ordinary income, the base captures wealth accumulation that a rate-based-only approach never reaches.

#### Q: What debates does this framework render moot?
...
| Rate wars (15% vs. 60%) | Gains are just income; rate debate is the income tax rate debate |
...
#### Q: What about income tax brackets?
...
The one structural dependency: because gains above the exemption are taxed as ordinary income, any change to income tax rates automatically applies to capital gains. This is a feature, not a bug — it means the system stays internally consistent without requiring separate capital gains rate legislation.

#### Q: What about the child tax credit?

A unified child benefit ($4,000/child, fully refundable, consolidating CTC/EITC/CDCC) will be addressed in a companion proposal. It is scoped out of this document to keep the capital gains framework laser-focused.
...
| NIIT | ~$25-33B | Becomes redundant; gains above exemption taxed at income rates far exceeding 3.8% |
| **Total** | **~$50-65B** | |
...
### 3. Successful Founder — Marcus, $20M Exit After 10 Years

CPI-adjusted gain: $19M. Other income: $300K. First-time use of lifetime exemption.
...
### 4. Mega Founder — Sarah, $100M Exit After 10 Years

CPI-adjusted gain: $95M. Other income: $500K.
...
Decedent's lifetime exemption unused. CPI-adjusted unrealized gains: $15M. Assets held average 20 years.
...
Lifetime exemption fully used. Borrows $5M/year against appreciated stock for personal consumption.

| | Current Law | This Framework |
|---|---|---|
| Lifestyle Loan | $5M | $5M |
| Taxable Gain Triggered | $0 | $5M (deemed realization, ordinary income) |
| Tax | $0 | ~$1.85M (at ~37%) |
...
Decedent's lifetime exemption fully used. CPI-adjusted unrealized gains: $400M. Average holding period: 25 years.
...
The following design choices are deliberate but debatable. We flag them here because honest frameworks invite scrutiny, and these are the points where reasonable people will disagree.
